...
public class TutorialManager : MonoBehaviour
{
    ...
    {
        GameObject instance = Instantiate(Resources.Load("Tutorial Arrow", typeof(GameObject))) as GameObject;
        instance.name = "Tutorial Arrow";
        instance = null;
    }
    public void findArrow()
    {
        GameObject Arrow = GameObject.Find("Tutorial Arrow");
        if (Arrow == null)
        {
            createArrow();
            ItemArrow = GameObject.Find("Tutorial Arrow").transform;
        }
        else
        {
